...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'bookings_expert_id_fkey') THEN ALTER TABLE ONLY "public"."bookings" ADD CONSTRAINT "bookings_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."bookings"
--     ADD CONSTRAINT "bookings_service_id_fkey" FOREIGN KEY ("service_id") REFERENCES "public"."expert_services"("id") ON DELETE CASCADE;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'bookings_service_id_fkey') THEN ALTER TABLE ONLY "public"."bookings" ADD CONSTRAINT "bookings_service_id_fkey" FOREIGN KEY ("service_id") REFERENCES "public"."expert_services"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."bookings"
--     ADD CONSTRAINT "bookings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'bookings_user_id_fkey') THEN ALTER TABLE ONLY "public"."bookings" ADD CONSTRAINT "bookings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."conversations"
--     ADD CONSTRAINT "conversations_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "public"."bookings"("id") ON DELETE SET NULL;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'conversations_booking_id_fkey') THEN ALTER TABLE ONLY "public"."conversations" ADD CONSTRAINT "conversations_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "public"."bookings"("id") ON DELETE SET NULL; END IF; END $$;
-- ALTER TABLE ONLY "public"."conversations"
--     ADD CONSTRAINT "conversations_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'conversations_expert_id_fkey') THEN ALTER TABLE ONLY "public"."conversations" ADD CONSTRAINT "conversations_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."conversations"
--     ADD CONSTRAINT "conversations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'conversations_user_id_fkey') THEN ALTER TABLE ONLY "public"."conversations" ADD CONSTRAINT "conversations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."expert_category_associations"
...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'expert_category_associations_category_id_fkey') THEN ALTER TABLE ONLY "public"."expert_category_associations" ADD CONSTRAINT "expert_category_associations_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."expert_categories"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."expert_category_associations"
...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'expert_category_associations_expert_id_fkey') THEN ALTER TABLE ONLY "public"."expert_category_associations" ADD CONSTRAINT "expert_category_associations_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."expert_services"
--     ADD CONSTRAINT "expert_services_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'expert_services_expert_id_fkey') THEN ALTER TABLE ONLY "public"."expert_services" ADD CONSTRAINT "expert_services_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."invitations"
--     ADD CONSTRAINT "invitations_invited_by_fkey" FOREIGN KEY ("invited_by") REFERENCES "auth"."users"("id");
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'invitations_invited_by_fkey') THEN ALTER TABLE ONLY "public"."invitations" ADD CONSTRAINT "invitations_invited_by_fkey" FOREIGN KEY ("invited_by") REFERENCES "auth"."users"("id"); END IF; END $$;
-- ALTER TABLE ONLY "public"."messages"
--     ADD CONSTRAINT "messages_conversation_id_fkey" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE CASCADE;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'messages_conversation_id_fkey') THEN ALTER TABLE ONLY "public"."messages" ADD CONSTRAINT "messages_conversation_id_fkey" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."messages"
--     ADD CONSTRAINT "messages_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'messages_sender_id_fkey') THEN ALTER TABLE ONLY "public"."messages" ADD CONSTRAINT "messages_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE; END IF; END $$;
-- ALTER TABLE ONLY "public"."profiles"
...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'reviews_booking_id_fkey') THEN ALTER TABLE ONLY "public"."reviews" ADD CONSTRAINT "reviews_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "public"."bookings"("id"); END IF; END $$;
-- ALTER TABLE ONLY "public"."reviews"
--     ADD CONSTRAINT "reviews_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id");
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'reviews_expert_id_fkey') THEN ALTER TABLE ONLY "public"."reviews" ADD CONSTRAINT "reviews_expert_id_fkey" FOREIGN KEY ("expert_id") REFERENCES "public"."profiles"("id"); END IF; END $$;
-- ALTER TABLE ONLY "public"."reviews"
--     ADD CONSTRAINT "reviews_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id");
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'reviews_user_id_fkey') THEN ALTER TABLE ONLY "public"."reviews" ADD CONSTRAINT "reviews_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id"); END IF; END $$;
